...
def search_command():
    list1.delete(0, END)
    for row in back.search(name_text.get(), address_text.get(), contact_text.get(), noof_text.get(),
                           roomtype_text.get(), amount_text.get()):
        list1.insert(END, row)


def add_command():
    back.insert(name_text.get(), address_text.get(), contact_text.get(), noof_text.get(), roomtype_text.get(),
                amount_text.get())
    list1.delete(0, END)
    list1.insert(END, (
        name_text.get(), address_text.get(), contact_text.get(), noof_text.get(), roomtype_text.get(),
        amount_text.get()))
#
#
def delete_command():
...
def update_command():
    back.update(selected_tuple[0], name_text.get(), address_text.get(), contact_text.get(), noof_text.get(),
                roomtype_text.get(), amount_text.get())
#
#
window = Tk()

label1 = Label(window, text="Hotel Grand Mansion")
...
label4 = Label(window, text="Contact")
...
entry3 = Entry(window, textvariable=contact_text)
